...
REM
REM Generated by Vivado on Mon Jul 04 20:05:23 +0530 2022
...
echo "xvlog --incr --relax -prj Datapth_TB_vlog.prj"
call xvlog  --incr --relax -prj Datapth_TB_vlog.prj -log xvlog.log
